...
const CategoryPieChartMoney: React.FC<{ data: CategoryData[] }> = ({ data }) => {
        ...
        datasets: [
            {
                ...
                data: data.map((category) => category.productCategoryRevenue),
            ...
            tooltip: {
                callbacks: {
                    label: function (tooltipItem: TooltipItem<'pie'>) {
                        ...
                        return `${tooltipItem.label}: ${value.toLocaleString()} VND`;
                    },
                },
            },
        },
...
export default CategoryPieChartMoney;
