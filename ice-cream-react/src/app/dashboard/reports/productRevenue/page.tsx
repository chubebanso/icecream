...
export default function CartPage(): React.JSX.Element {
  ...
  return (
    <Stack spacing={3}>
      <Stack direction="row" spacing={3} sx={{ marginBottom: 2 }} justifyContent="center">
        <Typography variant="h4" fontWeight="bold">DOANH THU THEO SẢN PHẨM</Typography>
      </Stack>
