...
// public ResponseEntity<Voucher> createVoucherController(@RequestBody Voucher
// voucher) {
...
// public ResponseEntity<Void> deleteVoucherById(@PathVariable("voucher_id")
// long voucher_id)
// throws IdInvalidException {
// if (voucher_id > 1500) {
// throw new vn.chubebanso.icecream.util.error.IdInvalidException("Khong tim
// thay voucher");
// }
