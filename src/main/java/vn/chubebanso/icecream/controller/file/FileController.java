...
public class FileController {
    ...
    public ResponseEntity<ResUploadFileDTO> upload(@RequestParam("file") MultipartFile file,
        ...
        // List<String> alowwExtension = Arrays.asList("doc", "pdf", "png", "jpeg",
        // "jpg");
        // boolean isValid = alowwExtension.stream().anyMatch(item ->
        // fileName.toLowerCase().endsWith(item));
        // if (!isValid) {
        // throw new StorageException("File chỉ được chứa định dạng
